...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      description: `Custom <a href="https://evolink.ai" class="text-primary" target="_blank">Evolink AI</a> settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      placeholder: 'evo_xxx',
      group: 'evolink',
      tip: 'Evolink API Key is used to access the Evolink AI API',
      tab: 'ai',
    },
    {
    ...
    {
      name: 'evolink_custom_storage',
      title: 'Evolink Custom Storage',
      type: 'switch',
      value: 'false',
      group: 'evolink',
      tab: 'ai',
      tip: 'Use custom storage to save files generated by Evolink (24-hour URL expiry)',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
